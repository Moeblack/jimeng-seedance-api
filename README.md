...
[![Node.js](https://img.shields.io/badge/Node.js-18+-green.svg)](https://nodejs.org/) [![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/) [![Docker](https://img.shields.io/badge/Docker-Supported-blue.svg)](https://www.docker.com/) [![License](https://img.shields.io/badge/License-GPL%20v3-blue.svg)](LICENSE) [![Discord](https://img.shields.io/badge/Discord-Join-5865F2.svg?logo=discord&logoColor=white)](https://discord.gg/c8RfjTPt)

> 💬 **Join our Discord**: [https://discord.gg/c8RfjTPt](https://discord.gg/c8RfjTPt) — Questions, feedback, and feature discussion.
>
> 🖥️ **Web UI**: We provide an out-of-the-box Windows 2000 retro-style async task management frontend — [jimeng-async-ui](https://github.com/Moeblack/jimeng-async-ui). Open `index.html` in your browser or visit the [GitHub Pages demo](https://moeblack.github.io/jimeng-async-ui/).
...
docker run -d \
  ...
  ghcr.io/moeblack/jimeng-seedance-api:latest
```
...
docker-compose up -d
# or
docker run -d --name jimeng-api -p 5100:5100 ghcr.io/moeblack/jimeng-seedance-api:latest
```
...
3.  **Generation Timeout**
    ...
    -   Video generation: up to 60 minutes max.
...
This project is a hard fork derived from [jimeng-api](https://github.com/iptag/jimeng-api) (licensed under GPL-3.0). We sincerely thank the original author and the open-source community for providing the excellent foundational architecture.

This repository is now maintained independently.
- The copyright of the core architecture belongs to the original authors.
- New features (such as Async Task Endpoints, UI Console, Audio Upload via VOD, etc.) are maintained in this repository.

This project continues to strictly follow the **GPL-3.0 Open Source License**.
